<template id="user-bmi">
  ...
  <div class="uploader container mt-5">
    <h1 class="mb-4 text-center">Upload BMI CSV</h1>
...
app.component("user-bmi", {
  ...
  methods: {
      ...
      reader.onload = () => {
        try {
          ...
          if (
            ...
            throw new Error(
                "Invalid CSV format. Required headers: height, weight, userId."
            );
          }
    ...
    async uploadData() {
      const endpoint = "http://localhost:7001/api/bmi";
